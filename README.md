About simhash-feedstock
=======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/simhash-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5166&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/simhash-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `simhash` can be installed with `conda`:
...
```
mamba install simhash
```

It is possible to list all of the versions of `simhash` available on your platform with `conda`:
...
```
mamba search simhash --channel conda-forge
```
...
mamba repoquery search simhash --channel conda-forge

# List packages depending on `simhash`:
mamba repoquery whoneeds simhash --channel conda-forge

# List dependencies of `simhash`:
mamba repoquery depends simhash --channel conda-forge
```
